...
backbone of React.js, the go-to frontend framework. Take our pal Jeff Atwood, the guy behind
[blog.codinghorror.com](https://blog.codinghorror.com) – his authority isn't from blogging but from creating Stack
Overflow and Discourse. Think of any top-notch programmer you look up to, quote, and admire, and I'll bet they've
crafted some open or closed-source software that's making life easier for us (doesn't have to be massive, but a solid
bunch of people are using it). No one really gives two hoots about your blog; let's be honest here.
