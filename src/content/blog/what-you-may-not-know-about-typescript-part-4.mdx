...
To handle these cases, you can write `declare` to indicate to TypeScript that there should be no runtime effect for
...
Because `public` is already the default visibility modifier, you don't need to write it on a class member, but
